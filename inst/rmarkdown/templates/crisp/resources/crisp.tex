...
% define a command to set spacing after each cventry based on OS
\usepackage{ifplatform}
\ifwindows
  \newcommand{\cventryspacing}{-1.8mm}
\else
  \newcommand{\cventryspacing}{-5.8mm}
\fi
...
%  \vspace{-2.0mm}
  ...
  \ifempty{#5}{\vspace{0.1mm}}{\vspace{\cventryspacing}}%
}
