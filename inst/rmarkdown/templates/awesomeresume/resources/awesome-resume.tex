...
\renewcommand*{\honorlocationstyle}[1]{{\fontsize{10pt}{1em}\bodyfont\slshape\color{awesome} #1}}
...
% Modify the environment cvhonors to allow more space after the section title
